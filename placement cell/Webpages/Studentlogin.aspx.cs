...
namespace placement_cell.Webpages
{
    public partial class Studentlogin : System.Web.UI.Page
    {
        ...
        protected void btnlogin_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from tblverification where emailid= '" + txtusername.Text.Trim() + "' and password='" + txtpassword.Text.Trim() + "'", con);
            SqlDataReader rdr1;
            ...
            if (rdr1.Read())
            {
                ...
                cmd = new SqlCommand("select * from tblstudents where emailid= '" + txtusername.Text.Trim() + "'", con);
        ...
        {
            string query;
            query = "select * from tblverification where emailid='" + txtemailid.Text.Trim() + "'";
            ...
            else
            {
                ...
                string sql = "insert into tblverification(emailid,password,verificationcode) ";
                ...
                Response.Redirect("Studentverification.aspx");
            }
        }
