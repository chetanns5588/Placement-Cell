...
namespace placement_cell.Webpages
{
    public partial class Studentverification : System.Web.UI.Page
    {
        ...
        {
            string query="select * from tblverification where emailid='" + txtusername.Text.Trim() + "' and password = '" + txtpassword.Text.Trim() + "' and verificationcode = '" + txtverificationcode.Text.Trim() + "'";
