<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Companylogin.aspx.cs" Inherits="placement_cell.Webpages.Companylogin" MasterPageFile="~/Webpages/user.Master" %>

<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

  <h1>Registered Company Login</h1>
<table id="logintable">
                    <tr>
                        <td>
