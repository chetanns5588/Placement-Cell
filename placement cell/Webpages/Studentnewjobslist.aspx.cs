...
{
    public partial class Studentnewjobslist : System.Web.UI.Page
    {
        string sql;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                sql = "select * from tblstudents_jobs s,tbljobs j where s.studemailid='" + studemailid + "' and s.status='Assigned' and s.jobid=j.jobid";
